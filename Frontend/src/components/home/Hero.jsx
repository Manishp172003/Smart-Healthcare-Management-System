    ...
    >
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 relative z-10 flex flex-col justify-center">
        ...
        <div className="w-full max-w-full lg:w-[52%] xl:w-[48%] py-4">
          ...
          <span className="inline-block mb-3.5 text-[#0D9488] text-xs font-bold tracking-[2px] uppercase animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            SMART HEALTHCARE PLATFORM
          </span>

          <h1 className="text-[#0F172A] text-4xl font-extrabold tracking-tight leading-[1.1] md:text-5xl lg:text-[56px] animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
            Better Health
            <br />
          ...
          {/* CTA Buttons */}
          <div className="flex items-center gap-3.5 mt-7 flex-wrap animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
            <Link to="/appointment" className="flex items-center justify-center gap-2 p-3.5 px-6 rounded-xl text-xs font-semibold text-white bg-gradient-to-br from-[#2563EB] to-[#0D9488] border-none shadow-[0_7px_18px_rgba(37,99,235,0.22)] transition-transform hover:-translate-y-0.5 hover:shadow-[0_10px_24px_rgba(37,99,235,0.3)]">
              <CalendarCheck size={18} />
              Book Appointment
            </Link>

            <Link to="/doctors" className="flex items-center justify-center gap-2 p-3.5 px-6 rounded-xl text-xs font-semibold text-[#2563EB] bg-white border border-[rgba(37,99,235,0.25)] shadow-sm transition-transform hover:-translate-y-0.5 hover:border-[#2563EB]">
          ...
          {/* Trust Features Grid */}
          <div className="grid grid-cols-2 gap-4 max-w-[500px] mt-10 md:gap-[20px_24px] animate-fadeInUp" style={{ animationDelay: '0.8s' }}>
