  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white border border-slate-100 rounded-3xl p-6 shadow-[0_4px_20px_rgba(15,23,42,0.02)] space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full border border-slate-200 bg-slate-50 disabled:bg-slate-50/50 disabled:text-slate-500 rounded-xl p-3 text-xs md:text-sm text-[#162235] outline-none transition focus:border-[#2563EB]"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <select 
                ...
                onChange={handleProfileChange}
                className="w-full border border-slate-200 bg-slate-50 disabled:bg-slate-50/50 disabled:text-slate-500 rounded-xl p-3 text-xs md:text-sm text-[#162235] outline-none"
              >
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          {/* Allergies Card */}
          <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-[0_4px_20px_rgba(15,23,42,0.02)] space-y-3">
        ...
        {/* Submit Actions */}
        {isEditing && (
          <div className="lg:col-span-3 flex justify-end gap-3 bg-white border border-slate-100 p-4 rounded-2xl shadow-sm">
            <button
              type="button"
              onClick={() => setIsEditing(false)}
              className="h-10 px-6 rounded-xl text-xs font-bold bg-slate-100 text-slate-600 hover:bg-slate-200 cursor-pointer"
            >
              Discard
            </button>
            <button
