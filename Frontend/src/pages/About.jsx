  ...
  return (
    <div className="bg-slate-50 text-slate-800 font-sans antialiased overflow-hidden min-h-screen flex flex-col">
      ...
      >
        ...
        <section id="platform" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 relative">
              ...
              <div className="absolute -bottom-6 -right-4 sm:right-6 bg-white/95 backdrop-blur-md px-6 py-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center font-bold shadow-inner">
                  <Smile className="w-6 h-6" />
                </div>
                <div>
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Trusted Community</p>
                  <p className="text-lg font-extrabold text-slate-900">10k+ Active Patients</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-sm font-semibold shadow-sm">
                <Activity className="w-4 h-4 text-blue-600" /> ABOUT US
              </div>
        ...
        <section className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-100 via-blue-50/40 to-slate-100 border-y border-slate-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
              <div>
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-blue-100 text-blue-600 text-sm font-semibold shadow-sm mb-3">
                  <Sparkles className="w-4 h-4 text-blue-600" /> CORE PRINCIPLES
                </div>
              ...
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className="w-11 h-11 rounded-full bg-white border border-slate-200 text-slate-700 flex items-center justify-center shadow-md hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-95"
                >
            ...
            <div className="relative overflow-hidden py-4">
              ...
              >
                {carouselCards.map((card, index) => (
                  ...
                  >
                    <div className="h-full bg-white p-8 sm:p-10 rounded-3xl border border-slate-200/90 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1.5 flex flex-col justify-between group">
                      <div className="space-y-6">
                        <div className={`w-14 h-14 rounded-2xl ${card.bgIconContainer} flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300`}>
                          {card.icon}
                        </div>
                      ...
                      <div className="pt-6 mt-6 border-t border-slate-100 flex items-center text-sm font-semibold text-blue-600 group-hover:text-teal-600 transition-colors">
        ...
        <section className="py-20 bg-slate-200/70 border-y border-slate-300/60 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-7 space-y-6">
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-blue-200 text-blue-700 text-sm font-semibold shadow-sm">
                    <Sparkles className="w-4 h-4 text-blue-600" /> WHY CHOOSE US
                  </div>
                  <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-slate-900">
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-300/80 bg-white group">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/60 via-transparent to-transparent flex items-end p-8">
                    <div className="text-white space-y-2">
                      <p className="text-xs font-semibold tracking-wider text-teal-400 uppercase">Next-Gen Care</p>
                      <h4 className="text-xl font-bold">Built for Patients & Providers</h4>
                      <p className="text-sm text-slate-200">Streamlining the healthcare ecosystem with reliability and trust.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="relative w-full overflow-hidden group py-4">
            ...
            <div className="flex w-max animate-marquee group-hover:[animation-play-state:paused]">
              ...
              {[...objectivesCards, ...objectivesCards].map((obj, index) => (
                <div 
                  key={index} 
                  className="w-[300px] sm:w-[360px] flex-shrink-0 mx-3 bg-white p-8 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between transition-all duration-300 hover:shadow-md"
                >
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className={`w-12 h-12 rounded-xl ${obj.badgeBg} border flex items-center justify-center shadow-sm`}>
                        {obj.icon}
                      </div>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-200/70 border-y border-slate-300/60 relative">
          
          <div className="max-w-7xl mx-auto">
            {/* Section Header */}
            <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-teal-200 text-teal-700 text-sm font-semibold shadow-sm">
                <Sparkles className="w-4 h-4 text-teal-600" /> SEAMLESS JOURNEY
              </div>
              <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-slate-900">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
              ...
              {[
                ...
                <div 
                  key={index} 
                  className="group relative bg-white p-8 rounded-3xl border border-slate-300/70 shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between overflow-hidden"
                >
                  ...
                  <div className="flex items-center justify-between mb-6 relative z-10">
                    <div className="w-14 h-14 rounded-2xl bg-slate-100 border border-slate-200 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-300">
                      {item.icon}
                    </div>
                    <span className={`text-xs font-black px-3 py-1 rounded-full border ${item.badgeColor} tracking-wider`}>
                      STEP {item.step}
                    </span>
                  </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
          <div className="bg-gradient-to-r from-blue-900 via-slate-900 to-teal-950 rounded-3xl p-10 sm:p-16 shadow-2xl relative overflow-hidden text-white">
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
                <Link 
                  to="/doctors" 
                  className="px-8 py-4 rounded-xl bg-teal-500 hover:bg-teal-600 text-slate-950 font-bold shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
                >
                  Find a Doctor <ArrowRight className="w-5 h-5" />
                </Link>
                <Link 
                  to="/contact" 
                  className="px-8 py-4 rounded-xl bg-white/10 hover:bg-white/20 text-white font-bold backdrop-blur-md border border-white/20 transition-all"
                >
                  Contact Us
                </Link>
              </div>
